    ...
    function loadNewElement(x) {
     ...
     function formatElement(element) {
        ...
        return "<h1 id='h1-info-tag'>Current Build: ID# </h1><h1 id='e-id'>" + element.id + "</h1><h1>Item ID: " + element.id + "</h1><h1>Inventory ID: " + element.object_id + "</h1>"
            ...
            + "<div class='container-left'><img src='https://stockvectorrigs.s3.amazonaws.com/" + element.picture + "' height='140' width='212'>" + sold_display + "</div>"
            ...
            + "<a class='color-vector' id='color-vector-a' href='https://stockvectorrigs.s3.amazonaws.com/" + element.confirmation_r + "'>SEE CONFIRMATION REPORT</a>"
            + "</div>"
            + "</div>"
            + "</div>"
