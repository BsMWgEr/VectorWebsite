...
urlpatterns = [
                  ...
                  path('canopies/', views.canopies, name="canopies"),
                  path('pulse-canopies/', views.canopies_pulse, name="canopies-pulse"),
                  path('sabre3-canopies/', views.canopies_sabre3, name="canopies-sabre3"),
